...
/* this is an array of records defining our form registration validation rules */
...
/* this is an array of records defining our form login validation rules */
...
let useForm = (~formType:FormTypes.formType, ~callback) => {
  ...
  /* create two new useReducers inside of useForm(). Why two?
